...
public class UIToolTabEntry extends CoreBillEntryBase implements IUIToolTabEntry
{
    public UIToolTabEntry()
    {
        super();
        registerInterface(IUIToolTabEntry.class, this);
    }
    public UIToolTabEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IUIToolTabEntry.class, this);
    }
    ...
    private UIToolTabEntryController getController() throws BOSException
    {
        return (UIToolTabEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getUIToolTabEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
