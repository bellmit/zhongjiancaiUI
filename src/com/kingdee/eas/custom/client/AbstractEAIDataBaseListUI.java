 ...
 * output class name
 */
public abstract class AbstractEAIDataBaseListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEAIDataBaseListUI.class);
    /**
     * output class constructor
     */
    public AbstractEAIDataBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEAIDataBaseListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.app", "EAIDataBaseQuery");
        //actionCancel
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.EAIDataBaseListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("dataSourceUser"));
        sic.add(new SelectorItemInfo("dataSourcePassword"));
        sic.add(new SelectorItemInfo("dataBaseType.name"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "EAIDataBaseListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.client.EAIDataBaseEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.EAIDataBaseFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.EAIDataBaseInfo objectValue = new com.kingdee.eas.custom.EAIDataBaseInfo();		
        return objectValue;
    }
