 ...
 * output class name
 */
public abstract class AbstractEAIDataBaseTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEAIDataBaseTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractEAIDataBaseTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.EAIDataBaseTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "EAIDataBaseTypeListUI");
    }
