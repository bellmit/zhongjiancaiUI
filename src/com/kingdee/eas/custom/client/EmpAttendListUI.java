 ...
 * output class name
 */
public class EmpAttendListUI extends AbstractEmpAttendListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmpAttendListUI.class);
    
    /**
     * output class constructor
     */
    public EmpAttendListUI() throws Exception
    {
        super();
    }
