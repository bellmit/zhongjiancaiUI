 ...
 * output class name
 */
public abstract class AbstractDateBaseLogEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDateBaseLogEditUI.class);
    ...
    protected com.kingdee.eas.custom.DateBaseLogInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDateBaseLogEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDateBaseLogEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.DateBaseLogEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.DateBaseLogInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "DateBaseLogEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.client.DateBaseLogEditUI.class.getName();
    }
