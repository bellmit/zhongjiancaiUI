 ...
 * output class name
 */
public abstract class AbstractSyncEmpLogEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSyncEmpLogEditUI.class);
    ...
    protected com.kingdee.eas.custom.SyncEmpLogInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSyncEmpLogEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSyncEmpLogEditUI.class.getName());
        ...
        // contmsg		
        this.contmsg.setBoundLabelText(resHelper.getString("contmsg.boundLabelText"));		
        this.contmsg.setBoundLabelLength(100);		
        this.contmsg.setBoundLabelUnderline(true);		
        this.contmsg.setVisible(true);
        // contdate		
        ...
        // txtmsg		
        this.txtmsg.setVisible(true);		
        this.txtmsg.setHorizontalAlignment(2);		
        this.txtmsg.setMaxLength(255);		
        this.txtmsg.setRequired(false);
        // pkdate		
        this.pkdate.setVisible(true);		
        this.pkdate.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtempNumber,txtmsg,pkdate}));
    ...
    public void initUIContentLayout()
    {
        ...
        contmsg.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(contmsg, null);
        contdate.setBounds(new Rectangle(10, 58, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("msg", String.class, this.txtmsg, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.SyncEmpLogEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.SyncEmpLogInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("msg", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("msg"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "SyncEmpLogEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.client.SyncEmpLogEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.SyncEmpLogFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.SyncEmpLogInfo objectValue = new com.kingdee.eas.custom.SyncEmpLogInfo();
