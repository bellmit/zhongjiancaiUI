...
import com.kingdee.eas.custom.DataFacadeFactory;
import com.kingdee.eas.framework.*;

/**
 * output class name
 */
public class UIToolListUI extends AbstractUIToolListUI
{
    private static final Logger logger = CoreUIObject.getLogger(UIToolListUI.class);
    
    /**
     * output class constructor
     */
    public UIToolListUI() throws Exception
    {
        super();
    }
    ...
    { 
    	DataFacadeFactory.getRemoteInstance().getAndPutDate("1");
    ...
    /**
     * output actionClearCatch_actionPerformed
     */
    public void actionClearCatch_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionClearCatch_actionPerformed(e);
    }

    /**
     * output actionResutPage_actionPerformed
     */
    public void actionResutPage_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionResutPage_actionPerformed(e);
    }
