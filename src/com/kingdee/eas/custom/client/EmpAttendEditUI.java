 ...
 * output class name
 */
public class EmpAttendEditUI extends AbstractEmpAttendEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmpAttendEditUI.class);
    
    /**
     * output class constructor
     */
    public EmpAttendEditUI() throws Exception
    {
        super();
    }
    /**
