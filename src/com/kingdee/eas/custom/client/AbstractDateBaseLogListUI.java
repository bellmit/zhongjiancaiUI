 ...
 * output class name
 */
public abstract class AbstractDateBaseLogListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDateBaseLogListUI.class);
    /**
     * output class constructor
     */
    public AbstractDateBaseLogListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDateBaseLogListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.app", "DateBaseLogQuery");
        //actionCancel
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.DateBaseLogListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "DateBaseLogListUI");
    }
    /**
