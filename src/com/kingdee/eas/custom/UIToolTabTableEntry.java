...
public class UIToolTabTableEntry extends CoreBillEntryBase implements IUIToolTabTableEntry
{
    public UIToolTabTableEntry()
    {
        super();
        registerInterface(IUIToolTabTableEntry.class, this);
    }
    public UIToolTabTableEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IUIToolTabTableEntry.class, this);
    }
    ...
    private UIToolTabTableEntryController getController() throws BOSException
    {
        return (UIToolTabTableEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getUIToolTabTableEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabTableEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabTableEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabTableEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabTableEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getUIToolTabTableEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
