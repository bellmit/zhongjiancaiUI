...
public class NotifyTodoSendContext implements Serializable
{
    ...
    static {
        (NotifyTodoSendContext.typeDesc = new TypeDesc((Class)NotifyTodoSendContext.class, true)).setXmlType(new QName("http://webservice.notify.sys.kmss.landray.com/", "notifyTodoSendContext"));
        ...
        NotifyTodoSendContext.typeDesc.addFieldDesc((FieldDesc)elemField);
    ...
    public synchronized boolean equals(final Object obj) {
        if (!(obj instanceof NotifyTodoSendContext)) {
            return false;
        }
        final NotifyTodoSendContext other = (NotifyTodoSendContext)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    public static TypeDesc getTypeDesc() {
        return NotifyTodoSendContext.typeDesc;
    }
    
    public static Serializer getSerializer(final String mechType, final Class _javaType, final QName _xmlType) {
        return (Serializer)new BeanSerializer(_javaType, _xmlType, NotifyTodoSendContext.typeDesc);
    }
    
    public static Deserializer getDeserializer(final String mechType, final Class _javaType, final QName _xmlType) {
        return (Deserializer)new BeanDeserializer(_javaType, _xmlType, NotifyTodoSendContext.typeDesc);
    }
}
